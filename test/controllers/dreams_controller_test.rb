...
class DreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dream" do
    assert_difference('Dream.count') do
      post dreams_url, params: { dream: { content: @dream.content, date: @dream.date, location: @dream.location, recurring: @dream.recurring } }, as: :json
    end
  ...
  test "should update dream" do
    patch dream_url(@dream), params: { dream: { content: @dream.content, date: @dream.date, location: @dream.location, recurring: @dream.recurring } }, as: :json
    assert_response 200
  end
