...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { city: @travel.city, content: @travel.content, country: @travel.country, date: @travel.date } }, as: :json
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { city: @travel.city, content: @travel.content, country: @travel.country, date: @travel.date } }, as: :json
    assert_response 200
  end
